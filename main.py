...
llm = ChatOpenAI(base_url='https://api.openai-proxy.org/v1')
...
def retrieval_chain_without_lcel(query:str):
    ...
    Manually retrieves, formats them, and generates a response.
...
def create_retrival_chain_with_lcel():
    """
    Create a retrival chain with LCEL.
    Return a chain that can be invoked with {"question":"..."}

    Advantages over non-LCEL approaches:
...
if __name__ == "__main__":
    ...
    # Query
    query = "what is Pincone is in machine learning?"
    ...
    # ========================================================================
    # Option 12: Use implementation WITH LCEL
    # ========================================================================
    print("\n" + "=" * 70)
