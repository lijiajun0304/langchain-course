...
# Difference 3:Delete the JSON schemas. Tools now live inside the prompt as plain text.
...
def run_agent(question: str):
    ...
    # CHANGE 5: One promopt string replaces the system/user message split.
    ...
    for iteration in range(1, MAX_ITERATIONS + 1):
        ...
        # Diffenence 7: Direct function call instead of tool.invoke()
